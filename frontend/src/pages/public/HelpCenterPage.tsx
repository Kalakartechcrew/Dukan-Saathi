            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
                  {categories.map((cat) => (
                    <div key={cat.title} className="group relative flex items-center gap-x-6 rounded-2xl border border-slate-200 p-6 hover:border-emerald-500 hover:shadow-sm transition-all cursor-pointer">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-slate-50 group-hover:bg-emerald-50">
                        <cat.icon className="h-6 w-6 text-slate-600 group-hover:text-emerald-600" />
                      </div>
                      <div>
              ...
              <div>
                ...
                <div className="mt-8 space-y-6">
                  <div className="rounded-2xl bg-emerald-50 p-8 border border-emerald-100">
                    <h3 className="text-lg font-bold text-emerald-900">Step 1: Setting up your shop</h3>
                    <p className="mt-2 text-emerald-800">Enter your business name, address, and GST number (if any) in the settings panel to customize your invoices.</p>
                  </div>
            ...
            <div className="space-y-8">
              <div className="rounded-3xl bg-slate-900 p-8 text-white">
                ...
                <div className="mt-8 space-y-4">
                  <a href="mailto:support@sathi.app" className="flex items-center gap-x-3 text-sm hover:text-emerald-400 transition-colors">
                    <Mail className="h-5 w-5" />
                    support@sathi.app
                  </a>
                  <a href="tel:+911234567890" className="flex items-center gap-x-3 text-sm hover:text-emerald-400 transition-colors">
                ...
                <Button className="mt-8 w-full bg-emerald-500 text-slate-950 hover:bg-emerald-400">
                  Open a Ticket
                </Button>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 p-8">
                ...
                <div className="mt-6 flex gap-4">
                  <div className="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center cursor-pointer hover:bg-emerald-50 hover:text-emerald-600">
